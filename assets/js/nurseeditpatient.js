...
/*****************************************************VITAL****************************************************************************/
	function saveVitalInformation(){
		...
		var clinicianId = jQuery("#clinicianId").val();
		...
		var vitalDate = jQuery("#pdate").val();
		
		jQuery.ajax({
			method : 'post',
			url:'nurvitalinformation.do',
			data : {"bloodGroup":bloodGroup,"bloodPressure":bloodPressure,"bodyTemp":bodyTemp,"clinicianId":clinicianId,"date":vitalDate,"height":height,"patientId":patientId,"pulseRate":pulseRate,"weight":weight},
			success:function(){
...
/*****************************************************ALLERGY****************************************************************************/
	function saveAllergyInformation(){
		...
		jQuery.ajax({
			method : 'post',
			url:'nurallergyinformation.do',
			data : {"allergyName":allergyName,"clinicianId":clinicianId,"endDate":endDate,"patientId":patientId,"reaction":reaction,"startDate":startDate,"status":status},
			success:function(){
				$("#allergyForm")[0].reset();
	...
	function updateAllergyInformation(){
		...
		jQuery.ajax({
			method : 'POST',
			url:'updatenurallergyinformation.do',
...
/*****************************************************CHRONIC****************************************************************************/
	...
	function saveChronicInformation(){
		...
		jQuery.ajax({
			method : 'post',
			url:'nuraddchronicillness.do',
			data : {"clinicianId":clinicianId,"endDate":endDate,"illness":illness,"patientId":patientId,"reaction":reaction,"startDate":startDate,"status":status},
			success:function(){
	...
	function getChronicinformation(){
		...
		jQuery.ajax({
			method : 'GET',
			url:'getnurchronicinformation.do',
			data :{"patientId":patientId},
			success:function(data){
	...
	function updateChronicInformation(){
		...
		jQuery.ajax({
			method : 'POST',
			url:'updatenurchronicinformation.do',
			...
			success:function(data){
				 ...
				 jQuery('#edit-chronic').modal('hide');
				getChronicinformation();
