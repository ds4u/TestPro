...
<head>
    ...
    <meta name="author" content="#">
        ...
        <title>Message</title>
           ...
           <!-- DataTables -->
<link href="assets/plugins/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />.css">
                    ...
                    <!--- Sidemenu -->
                     <div id="sidebar-menu">
                        <ul>                        	
                            ...
                            <li>
                                <a href="phymessages.do" class="waves-effect active"><i class="fa fa-envelope"></i><span> Messages </span></a>
                            </li>
                            <li>
