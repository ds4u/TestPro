                    ...
                    <!--- Sidemenu -->
                      <div id="sidebar-menu">
                        <ul>                        	
                            ...
                            <li>
                                <a href="phytodolist.do" class="waves-effect active"><i class="fa fa-list"></i> <span> To Do List </span> </a>
                            </li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="toDoList" class="table table-bordered">
                                            ...
                                            <c:forEach var= "list" items="${toDoList}">
                                                <tr>
                                                    <td>${list.fromDate}</td>
                                                    <td><a href="phylistpatient.do">${list.pFirstName} ${list.pLastName}</a></td>
                                                    <td>Create a <a href="phyeditpatient.do?id=${list.id}">Intake Note</a> for your<a href="phyappointment.do"> Appointment on ${list.fromDate}${list.sFromTime}</a></td>                                                   
                                                </tr>  
                                                </c:forEach> 
                                              </c:if>                                     
                                            </tbody>
