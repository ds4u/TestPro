    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="bg-picture card-box2">
                                    <div class="search">
                                        <form action="phypatientsearch.do" method="POST">
                                            <div class="row">
                                                <div class="col-sm-4">
                                    ...
                                    <div class="for-level ">
                                    <table class="table table-bordered table-striped" id="phylistpatient">
                                        <thead>
                                            <tr>
                                          ...
                                          <c:if test="${not empty listpatient}">
												...
												<c:forEach var="patient" items="${listpatient}">
													<tr>
														...
														<a href="phyeditpatient.do?id=${patient.id}">
         ...
         <div class="side-bar right-bar">
                <a href="javascript:void(0);" class="right-bar-toggle">
                    <i class="zmdi zmdi-close-circle-o"><z/i>
                </a>
