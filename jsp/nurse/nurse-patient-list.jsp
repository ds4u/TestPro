<%@page import="com.dreamsoft4u.queehr.shared.dto.PatientDTO"%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="bg-picture card-box2">
                                    <div class="search">
                                       <form  method="post"  action="nursepatientsearch.do">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Patient Name</label>
                                                        <input type="text" value="" class="form-control" name="patientName" placeholder="Enter Name" />
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="nursepatient">
                                            <thead>
                                                <tr>
                                            ...
                                            <c:forEach var="patient" items="${listpatient}">
                                                <tr>
                                                  ...
                                                  <c:set var="gender" value="${patient.gender}"></c:set>
                                                  <% Integer gender=(Integer)pageContext.getAttribute("gender"); %>
                                                    ...
                                                    <td>
                                                    <form:form method="post" name="abc${patient.id}" action="nurseeditpatients.do">
															<input type="hidden" value="${patient.id}" name="id"/>
															<input type="hidden" name="clinicianid" value="${patient.clinicianId }"/>
														<a href="#"><i id="editstaff" onclick="window.document.abc${patient.id}.submit()"
