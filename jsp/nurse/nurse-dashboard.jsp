        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        <li>
                            <a href="nursedashboard.do" class="waves-effect active"><i class="zmdi zmdi-view-dashboard"></i> <span> Dashboard </span> </a>
                        </li>
                        <li>
                            <a href="nurselistpatient.do" class="waves-effect"><i class="fa fa-wheelchair"></i> <span> Patients </span> </a>
                        </li>                       
                    </ul>
                            ...
                            <div class="card-box">
                                ...
                                <div class="widget-chart-1">
                                    ...
                                    <div class="widget-detail-1">
                                        <h2 class="p-t-10 m-b-0" id="nurse_total_appointment"> ${Total} </h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            <div class="card-box">
                                ...
                                <div class="widget-chart-1">
                                    ...
                                    <div class="widget-detail-1">
                                        <h2 class="p-t-10 m-b-0" id="nurse_waiting_appointment"> ${Waiting} </h2>
                ...
                <div class="modal-content">
                    <div class="modal-header" id="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Change Password</h4>
                                         ...
                                         <form:form data-parsley-trigger="input" name="frm" data-parsley-focus="first" enctype="multipart/form-data" class="form-horizontal m-t-20" method="post" commandName="address" action="nurse-reset-password.do" id="changePassword">
                               <form:hidden path="id"/>
                    ...
                    <% String message=session.getAttribute("message")!=null?session.getAttribute("message").toString():"";
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="password"  value="" data-parsley-trigger="focusout"  placeholder="Enter old password" class="form-control" id="oldpassword" required="required"/>
                                   </div>
                                   <div class="form-group">
...
<!--End Modal -->
    ...
    jQuery("document").ready(function($){
    	 getNurseDashboardCounter();
    	 
    	  /* setInterval(function(){ getNurseDashboardCounter(); }, 15000); */
    ...
    function getNurseDashboardCounter() {
    	setInterval(function(){ var baseurl="${pageContext.request.contextPath}";
  	  
    	jQuery.ajax({
    		url:baseurl+"/getNurseDashboardCounter.do",
    		method:"GET",
    		success:function(data){
    			obj = JSON.parse(data);
    			document.getElementById("nurse_total_appointment").innerHTML = obj.Total;
    			document.getElementById("nurse_waiting_appointment").innerHTML = obj.Booked;
    		},
    		fails:function(error){
