...
<head>
 ...
 <%String image=session.getAttribute("imagepath")!=null?session.getAttribute("imagepath").toString():"";%>
                    ...
                    <div id="sidebar-menu">
                        <ul>                        	
                            <li>
                                <a href="nurse-dashboard.html" class="waves-effect "><i class="zmdi zmdi-view-dashboard"></i> <span> Dashboard </span> </a>
                            </li>

                            <li>
                                <a href="nurse-patients.html" class="waves-effect active"><i class="fa fa-wheelchair"></i> <span> Patients </span> </a>
                            </li>
                        </ul>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="nurse-edit-patients.html"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Rajesh Tailor</td>
