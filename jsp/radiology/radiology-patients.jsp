					...
					<div class="row">
						<div class="col-sm-12">
							<div class="bg-picture card-box2">
								<div class="search">
									 <form action="radiopatientsearch.do" method="POST">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>Patient Name</label>
                                                        <input type="text" value="" name="patientName" class="form-control" placeholder="Enter Name">
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="form-group">
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="radiolistpatient">
										<thead>
											<tr>
                                          ...
                                          <c:if test="${not empty listpatient}">
												...
												<c:forEach var="patient" items="${listpatient}">
													<tr>
														...
														<a href="radioeditpatient.do?id=${patient.id}">
