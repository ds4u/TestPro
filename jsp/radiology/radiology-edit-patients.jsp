...
<body class="fixed-left">
			...
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li><a href="radiologypatient.do" class="waves-effect active"><i
							...
							<div class="bg-picture card-box2">
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a href="#three"
										aria-controls="three" role="tab" data-toggle="tab">Open
											Task</a></li>
									<li role="presentation"><a href="#five"
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="one">
										<form:form commandName="address" action="radioeditpatient.do"
											method="GET">
											<div class="row">
												<div class="col-sm-4">
												...
												<div class="col-sm-4">
													<div class="form-group">
														<label>Email</label>
														<form:input path="user.emailAddress" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input type="text" path="user.dateOfBirth" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input type="text" path="user.firstName" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input type="text" path="user.middleName" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input name="name" path="user.lastName" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group">
														<label>Gender</label> <input name="name" value="${gender}"
															class="form-control" disabled />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														<label>Marital Status</label> <input name="name"
															path="middleName" value="${maritalStatus}"
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input path="user.mobileNumber" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
											...
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input path="user.homeNumber" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input name="name" path="addressLineOne" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input name="name" path="addressLineTwo" value=""
															class="form-control" disabled="true" />
													</div>
												</div>
											...
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group">
														<label>City</label> <input name="name" value="${city}"
															class="form-control" disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														...
														<form:input path="zipcode" value="" class="form-control"
															disabled="true" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														<label>State</label> <input name="name" value="${state}"
															class="form-control" disabled="true" />
													</div>
												</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label>Email</label> <input type="text" name="name"
														value="${gurantor.userName}" class="form-control" disabled />
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label>Date of Birth</label> <input type="text" name="name"
														value="${gurantor.dateOfBirth}" class="form-control"
														disabled />
												</div>
											</div>
										</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label>Last Name</label> <input type="text" name="name"
														value="${gurantor.lastName}" class="form-control" disabled />
												</div>
											</div>
										</div>
										<div class="row">
													...
													<c:if test="${not empty openTaskList}">
														<c:forEach var="task" items="${openTaskList}"
															...
															<tr>
																...
																<td>Upload X-ray Report for This appointment</td>
																<td><a class="opentask" data-appid=${task.id
																	} href="#"><i class="fa fa-upload"
 ...
 -->
	...
	<script>
		...
		setDownloadFile(userType.radiologst);
	</script>
...
<script>
	/* 	 $(document).ready(function () {
			 jQuery('#openTaskTable').dataTable({
		    	 "order": [[ 0, "desc" ]],
		    	 "columnDefs": [
