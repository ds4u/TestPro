...
<body class="fixed-left">
			...
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li><a href="labappointment.do" class="waves-effect active"><i
													...
													<div class="col-sm-3">
														<div class="form-group">
															<label>From Date</label> <input type="text" value=""
																class="form-control" data-parsley-trigger="change" id="fromdate" name="fromdate"
													...
													<div class="col-sm-3">
														<div class="form-group">
															<label>To Date</label> <input type="text" value=""
																class="form-control" data-parsley-trigger="change" id="todate" name="todate"
																placeholder="MM/DD/YYYY">
														</div>
													</div>
												</div>
 ...
 -->
	...
	$("#imgPath").attr('src', $.cookie("imagePath"));
		...
		setAppointmentList(userType.lab, '', '');
		...
		$("#searchappointment").click(
				function() {
					...
					setAppointmentListSearch(userType.lab, phyname,
