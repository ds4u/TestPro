...
<body class="fixed-left">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="bg-picture card-box2">
								<div class="search">
									 <form action="labpatientsearch.do" method="POST">
										<div class="row">
											<div class="col-sm-4">
											...
											<div class="col-sm-8">
												<div class="form-group">
													...
													<button type="submit" id="searchpatient" class="btn btn-primary">
										...
										<c:if test="${not empty listpatient}">
												...
												<c:forEach var="patient" items="${listpatient}">
													<tr>
														...
														<a href="labeditpatient.do?id=${patient.id}">
 ...
 -->
	...
	$("#imgPath").attr('src', $.cookie("imagePath"));
		setPatientList(userType.lab, '', '');

		$("#searchpatient").click(function() {
			var patientname = $("#patientname").val();
			console.info(patientname);
			setPatientListSearch(userType.lab, patientname, '', '');
		});
	</script>
