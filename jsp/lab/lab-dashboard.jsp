	...
	<div id="wrapper">
		...
		<div class="left side-menu">
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						<li><a href="labdashboard.do" class="waves-effect active"><i
						...
						<li><a href="labpatient.do" class="waves-effect"><i
						...
						<div class="modal-dialog modal-sm" role="document">
							<div class="modal-content">
								...
								<form:form data-parsley-trigger="input" name="frm"
									...
									commandName="address" action="lab-reset-password.do"
									id="changePassword">
									<form:hidden path="id" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                       ...
                       <form:form data-parsley-trigger="input" data-parsley-focus="first" enctype="multipart/form-data"  action="labeditprofile.do" method="post" commandName="address" id="editAdmin">
                       <form:hidden path="id"/>
                       <form:hidden path="user.id"/>
                       <form:hidden path="user.isAdmin"/>
                       <form:hidden path="user.department.id"/>
                       <form:hidden path="user.isEnabled"/>
                       <form:hidden path="user.password" value="${password}" id="userpassword"/>
                    ...
                    <div class="modal-body">
                           ...
                           <div class="row">
                               <div class="col-sm-6">
                                   <div class="form-group">
                                      ...
                                      <form:input  required="required" type="text" path="user.userName" id="username" data-parsley-length="[2, 20]" data-parsley-type="alphanum" data-parsley-trigger="focusout" placeholder="Enter Username" class="form-control"  readOnly="true" />
                                   </div>
                               </div>
                               <div class="col-sm-6">
                                   <div class="form-group">
                                       <label>Email Address</label>
                                       <form:input path="user.emailAddress" data-parsley-pattern = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$"  value="" data-parsley-trigger="focusout" data-parsley-length="[2, 45]" placeholder="Enter Email" id="email" class="form-control" readOnly="true"/>
                                   </div>
                               </div>
                           </div>
                           ...
                           <div class="row">
                            <div class="col-sm-6">
                                   <div class="form-group">
                                       <label>State</label>
                                       <form:select  path="stateID" value="" placeholder="Enter State" class="form-control" data-parsley-trigger="focusout" data-parsley-error-message="Select State" required="required">
						...
						<div class="col-sm-12">
							<div class="bg-picture card-box2">
								<div class="profile-info-name">
									<img id="imgPath1" src="assets/images/profile.jpg" class="img-thumbnail"
										alt="profile-image">

									<div class="profile-info-detail">
										<h3 class="m-t-0 m-b-0">
											<span id="name">Alexandra Clarkson</span> 
											<!-- <a href="#"
 ...
 -->
	...
	<script>
		...
		setTimeout(function() {
			...
			setDashBoardCount(userType.lab);

			setUserDetails(userType.lab);

			setUpcomingAppointment(userType.lab);
