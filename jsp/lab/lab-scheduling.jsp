...
<body class="fixed-left">
			...
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li><a href="labscheduling.do" class="waves-effect active"><i
										...
										<div class="col-md-2">
											<div class="form-group">
												<label>From Time</label> <input class="form-control"
													id="fromtime" name="fromtime" placeholder="00.00AM"
													type="text">
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
												<label>To Time</label> <input class="form-control"
													id="totime" name="totime" placeholder="00.00AM" type="text">
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
 ...
 -->
	...
	$("#imgPath").attr('src', $.cookie("imagePath"));
		...
		setSchedulingAvailblityGet(userType.lab, '', '');
		...
		//$("#insertscheduling").click(
				var insertscheduling=function() {
					...
					setSchedulingAvailblityInsert(userType.lab, fromdate,
