...
<body class="fixed-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="bg-picture card-box2">                               
                                ...
                                <form:form data-parsley-trigger="focusout" data-parsley-focus="first"  method="POST" action="cmscontactus.do" commandName="address" id="cmscontactus">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <form:input  type="text" data-parsley-pattern="^[a-zA-Z0-9_ .-]*$" data-parsley-length="[2, 20]" path="user.firstName" id="firstName" data-parsley-trigger="focusout" value="" placeholder="Enter First Name" class="form-control" required="required" />
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <form:input type="text" data-parsley-pattern="^[a-zA-Z0-9_ .-]*$" data-parsley-length="[2, 20]" path="user.lastName" id="lastName" value="" data-parsley-trigger="focusout"  placeholder="Enter Last Name" class="form-control" required="required" />
                                             ...
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <form:input type="text" path="addressLineOne" id="addressLineOne" value="" data-parsley-trigger="focusout" data-parsley-error-message="Enter Address Line" placeholder="Enter Address 1" class="form-control" required="required" />
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                             ...
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>State</label> 
                                                   <form:select type="text" path="stateID" value="" placeholder="Enter ZipCode" class="form-control" id="statelist" data-parsley-trigger="focusout" data-parsley-error-message="Select State" required="required">
 ...
 -->                                                   <!--  <input type="text" name="name" value="${city.name}" placeholder="Enter City" class="form-control" /> -->
                                                   <label>City</label>
                                                   <form:select  path='cityID' class='form-control' id="city" data-parsley-trigger="focusout" data-parsley-error-message="Select City" required="required">
                                                   <form:option value="" >-Select-</form:option>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>ZipCode</label>
                                                    <form:input  path="zipcode" id="zipcode" value="" placeholder="Enter ZipCode" class="form-control" data-parsley-length="[6, 8]" required="required" data-parsley-trigger="focusout" data-parsley-type="alphanum" />
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <form:input type="text" path="user.mobileNumber" id="mobileNumber" value="" placeholder="Enter Mobile Phone" class="form-control" data-parsley-length="[10, 14]" required="required" data-parsley-type="digits" data-parsley-trigger="focusout" />
                                             ...
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <form:input type="text" path="user.homeNumber" value="" placeholder="Enter Home Phone" class="form-control"  data-parsley-length="[10, 14]" data-parsley-type="digits" data-parsley-trigger="focusout"/>
                                                </div>
                                            </div>
                                          </div>
                                          <div class="row">                                           
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group text-right">
                                                    ...
                                                    <a href="cmscontactus.do" class="btn btn-danger">Cancel</a>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
