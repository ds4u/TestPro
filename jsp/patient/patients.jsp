    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div class="user-box">
                    <div class="user-img">
                        <img src="${imagepath}" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="listpatient.do" class="waves-effect active"><i class="fa fa-wheelchair"></i> <span> Patients </span></a>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="cmscontactus.do">Information</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="bg-picture card-box2">
                                <div class="search">
                                      <form  method="post"  action="patientsearch.do">
                                        <div class="row">
                                            <div class="col-sm-4">
